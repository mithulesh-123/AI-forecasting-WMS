...
- Name: auth.spec.ts >> Session Management & RBAC Enforcement >> enforces role-based guards: Staff is redirected away from forbidden routes
- Location: tests\e2e\auth.spec.ts:152:7
