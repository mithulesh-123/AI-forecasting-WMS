...
- Name: auth.spec.ts >> Authentication - Invalid Cases and Normalization >> handles email with whitespace and mixed casing correctly
...
Received string:  "http://localhost:3000/login?email=Admin%40NexusWMS.io&password=Password123%21"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × locator resolved to <html lang="en" class="__variable_8adcd2 light">…</html>
       - unexpected value "http://localhost:3000/login?email=Admin%40NexusWMS.io&password=Password123%21"
