...
- Name: auth.spec.ts >> Session Management & RBAC Enforcement >> enforces role-based guards: Viewer is redirected away from Users and Audit Logs
- Location: tests\e2e\auth.spec.ts:171:7
